...
fn main() {
    ...
    let _spec3 = Material {
        color: Vec3f::new(0.0, 1.0, 0.0).normalize(),
        diffuse: 0.8,
        translucency: 0.0,
        ref_index: 1.,
        specular: 0.2,
    ...
    let _spheres = vec![
        Sphere {
            radius: 4.0,
            center: Vec3f::new(-5., 3., -32.),
            material: _spec2,
        },
        Sphere {
            radius: 3.0,
            center: Vec3f::new(0., 1.5, -16.),
            material: _glass,
        },
        Sphere { radius: 3., center: Vec3f::new(4.5, 5.5, -18.), material: _spec1 },
        Sphere { radius: 3., center: Vec3f::new(6., 2., -14.), material: _spec3 },
    ];
    let _lights = vec![Light::new(Vec3f::new(-10., 20., -16.), 1.5),
